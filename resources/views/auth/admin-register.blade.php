<x-guest-layout>
    ...
    <div class="flex justify-center items-center w-full h-screen bg-[#F5F8F8]">
        <div class="opacity-20 lg:opacity-100 w-full h-full bg-cover bg-center absolute lg:static top-0 left-0" style="background-image: url('{{ asset('image/login-admin-image.png') }}');">
        </div>
        ...
        <div class="w-full h-full flex flex-col justify-center items-center z-50">
            <div class="w-full lg:w-[26rem] flex flex-col items-center lg:items-start">
                ...
                <form method="POST" action="{{ route('register') }}" class="flex flex-col gap-y-14 mt-24 lg:mt-16 w-fit lg:w-full">
                    ...
                    <div class="flex flex-col gap-y-5">
                        <div class="flex gap-x-4">
                            <a href="/login-admin" class="bg-[#345E5C] w-36 font-semibold text-center text-sm py-2 rounded-md text-white">Login</a>
                            <button type="submit" class="border border-[#345E5C] w-36 font-thin text-center text-sm py-2 rounded-md">
                                Register
                            </button>
                        </div>
                    </div>
