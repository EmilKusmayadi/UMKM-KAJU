    ...
    <div class="flex justify-center items-center w-full h-screen bg-[#F5F8F8]">
        ...
        <div class="w-full h-full flex flex-col justify-center items-center z-50">
            <div class="w-full lg:w-[26rem] flex flex-col items-center lg:items-start">
                ...
                <form method="POST" action="{{ route('login') }}" class="flex flex-col gap-y-14 mt-24 lg:mt-16 w-fit lg:w-full">
                    ...
                    <div class="flex flex-col gap-y-5">
                        <div class="flex gap-x-4">
                            <button type="submit" class="bg-[#345E5C] w-36 font-semibold text-sm py-2 rounded-md text-white">Login</button>
                            <a href="/register-admin" class="border border-[#345E5C] w-36 font-thin text-center text-sm py-2 rounded-md">
                                Register
                            </a>
                        </div>
                    </div>
