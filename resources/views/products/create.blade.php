<x-app-layout>
    ...
    <form action="/products" method="POST" enctype="multipart/form-data"
        ...
        <div class="mb-4">
            ...
            <input type="text" name="product_name_ind" id="product_name_ind" class="mt-1 p-2 w-full border rounded-md"
                value"">
        ...
        <div class="mb-4">
            ...
            <input type="text" name="product_qty" id="product_qty" class="mt-1 p-2 w-full border rounded-md" value"">
            @error('product_qty')
                <div class="text-red-500 text-xs">{{ $message }}</div>
            @enderror
        </div>
        ...
        <div class="mb-4">
            ...
            <input type="text" name="hot_deals" id="hot_deals" class="mt-1 p-2 w-full border rounded-md" value"">
            @error('hot_deals')
                <div class="text-red-500 text-xs">{{ $message }}</div>
            @enderror
        </div>
        <div class="mb-4">
            ...
            <input type="text" name="featured" id="featured" class="mt-1 p-2 w-full border rounded-md" value"">
            @error('featured')
                <div class="text-red-500 text-xs">{{ $message }}</div>
            @enderror
        </div>
        ...
        <div class="mb-4">
            ...
            <input type="text" name="status" id="status" class="mt-1 p-2 w-full border rounded-md" value"">
            @error('status')
                <div class="text-red-500 text-xs">{{ $message }}</div>
            @enderror
        </div>
