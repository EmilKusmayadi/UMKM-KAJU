    ...
    <body class="hold-transition sidebar-mini">
        <div class="wrapper">
            ...
            <div class="content-wrapper">
                ...
                <div class="content">
                    <div class="container-fluid">
                        <div class="bg-white p-6 rounded-md shadow-md overflow-x-scroll">
                            <a href="/footers/create" class=" font-semibold bg-sky-400 p-2 rounded-lg">+Tambah Data
                                Footer</a>
                                    ...
                                    @foreach ($footer as $datas)
                                        <tr>
                                            ...
                                            <td class="py-2 px-4 border-b flex">
                                                <a href="{{ url('/footers/' . $datas->id . '/edit') }}"
                                                ...
                                                <form onsubmit="return confirm('Yakin mau hapus data')"
                                                    action="{{ '/footers/' . $datas->id }}" method="POST"
