                ...
                <div class="content">
                    <div class="container-fluid">
                        <div class="max-w-4xl mx-auto bg-white p-6 rounded-md shadow-md ">
                            <a href="/abouts/create" class=" font-semibold bg-sky-400 p-2 rounded-lg">+Tambah Data
                                About</a>
                                            ...
                                            <td class="py-2 px-4 border-b">
                                                @if ($datas->about_image)
                                                    <img style="max-width: 50px; max-height:50px"
                                                        src="{{ url('about_image') . '/' . $datas->about_image }}"
                                                        alt="">
                                                @endif
                                            </td>
                                            <td class="py-2 px-4 border-b flex">
                                                <a href="{{ url('/abouts/' . $datas->id . '/edit') }}"
                                                ...
                                                <form onsubmit="return confirm('Yakin mau hapus data')"
                                                    action="{{ '/abouts/' . $datas->id }}" method="POST"
