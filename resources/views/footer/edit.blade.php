<x-app-layout>
    ...
    <form action="{{ '/footer/' . $data->id }}" method="POST" enctype="multipart/form-data"
        ...
        <div class="mb-4">
            ...
            <input type="text" name="number" id="number" class="mt-1 p-2 w-full border rounded-md"
                value="{{ $data->number }}">
        </div>
        <div class="mb-4">
        ...
        <div class="mb-4">
            ...
            <input type="text" name="adress" id="adress" class="mt-1 p-2 w-full border rounded-md"
                value="{{ $data->adress }}">
        </div>
        <div class="mb-4">
        ...
        <div class="mb-4">
            ...
            <input type="text" name="facebook" id="facebook" class="mt-1 p-2 w-full border rounded-md"
                value="{{ $data->facebook }}">
        </div>
        <div class="mb-4">
            <label for="twitter" class="block text-sm font-medium text-gray-600">twitter</label>
            <input type="text" name="twitter" id="twitter" class="mt-1 p-2 w-full border rounded-md"
                value="{{ $data->twitter }}">
        </div>
        <div class="mb-4">
            <label for="copyright" class="block text-sm font-medium text-gray-600">copyright</label>
            <input type="text" name="copyright" id="copyright" class="mt-1 p-2 w-full border rounded-md"
