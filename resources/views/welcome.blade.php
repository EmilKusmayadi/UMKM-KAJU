    ...
    <main class="px-8">
        <div class="relative mt-2 rounded-2xl overflow-hidden flex justify-center items-center h-screen">
            ...
            <div class=" z-10 w-full h-0  md:h-full flex flex-col justify-end md:p-16 md:space-y-10">
                ...
                <p class="text-sm md:text-[12px] text-white w-72">Dengan bangga menawarkan sayuran hidroponik tanpa
                    pestisida</p>
                <a href="#">
        ...
        <div class="w-full grid justify-between items-center grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-3">
            ...
            <div class="lg:hidden bg-[#FFE1EA] flex justify-center items-end h-52 md:h-64 px-3 py-5 gap-x-8 rounded-xl">
                <div class="flex flex-col justify-between h-full">
                    ...
                    <a href="#">
                        <button class="bg-green px-6 py-2 ms-3 text-white font-light rounded-lg text-sm">Beli
                            Sekarang</button>
                    </a>
                </div>
        ...
        <div class="w-full flex flex-col gap-y-8 justify-center items-center mb-16 mt-10 md:mb-28 md:mt-16 text-center">
            ...
            <h1 class="text-old-gray text-[16px] md:text-4xl font-normal">Hasil Hidroponik terbaik dari
                kebun<br>hidroponik terbaik</h1>
        </div>
        ...
        <div class="w-full flex justify-center items-center rounded-2xl md:rounded-r-2xl h-[160px] md:h-96 bg-green">
            <div class="md:w-full w-[500px] h-[190px] md:h-[500px] rounded-2xl overflow-hidden">
                <img src="{{ asset('image/getty-images-oIXoJSXuCpw-unsplash 2.png') }}" alt=""
                    class="h-[190px] w-[500px] md:h-full md:w-full">
            </div>

            <div
                class="text-white w-full h-full flex flex-col items-start justify-center md:gap-y-8 md:pl-10 md:pr-14 pl-4">
        ...
        <h1 class="text-green font-bold text-[14px] md:text-2xl text-center mt-32 mb-16">Penuhi Kebutuhan Sayur & Buah
        </h1>
