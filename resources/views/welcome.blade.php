    ...
    <body class="bg-[#F5F5F5]">
        ...
        <main class="px-8">
            ...
            <div class="w-full flex justify-between items-center gap-x-4 xl:gap-x-4">
                ...
                <div class="bg-[#E9ECF4] flex justify-center xl:justify-between items-end w-full h-64 xl:h-72 px-4 py-5 gap-x-8 rounded-2xl">
                ...
                <div class="bg-[#EAD9CF] flex justify-center xl:justify-between items-end w-full h-64 xl:h-72 px-4 py-5 gap-x-8 rounded-2xl">
                    <div class="flex flex-col justify-between h-full">
                        <p class="font-bold">Sayur</p>
                ...
                <div class="bg-[#F3E8E8] flex justify-center xl:justify-between items-end w-full h-64 xl:h-72 px-4 py-5 gap-x-8 rounded-2xl">
                    <div class="flex flex-col justify-between h-full">
                        <p class="font-bold">Sayur</p>
