    ...
    <main class="px-3 lg:px-8">
        ...
        <div class="text-old-gray w-full flex flex-col gap-y-16">
            <div class="w-full flex justify-between items-end">
                ...
                <a href="{{ url('/shop') }}" class="uppercase border-b-[1px] border-black px-1 font-light">semua</a>
            </div>
        ...
        <div class="grid grid-cols-2 gap-3 md:hidden">
            ...
            @foreach ($product as $datas)
                @if ($loop->iteration <= 5)
                    <div
                        class="bg-white p-5 h-[16rem] sm:h-[10rem] w-full sm:w-full md:w-1/2 lg:w-1/5 rounded-2xl flex flex-col justify-end items-center gap-y-4">
    ...
    <div class="relative bg-peanut p-10 flex justify-center items-center gap-x-10 rounded-2xl">
        <div>
            <div class="text-old-gray w-80 flex flex-col gap-y-7">
                ...
                <a href="{{ url('/about') }}"
                    class="border-b border-black py-1 w-fit font-light text-black">About Us</a>
            </div>
...
<div class="w-full flex justify-between items-center text-white">
    ...
    <a href="{{ url('/shop') }}" class="uppercase border-b-[1px] border-white px-1 font-light">semua</a>
</div>
